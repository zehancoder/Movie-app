...
function CartoonHorse() {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=1a05bd3a661c3ad18b28dfdde27416e8&with_keywords=257807&page=${page}`,
      options
    )
      .then((res) => res.json())
