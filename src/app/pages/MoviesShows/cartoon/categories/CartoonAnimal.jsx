...
function CartoonAnimal() {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=1a05bd3a661c3ad18b28dfdde27416e8&with_keywords=271856&page=${page}`,
      options
    )
      .then((res) => res.json())
  ...
  return (
    <div className="overflow-hidden w-screen py-8">
      ...
      <Container className={"mx-auto h-full relative xl:p-0"}>
        <div>
          <Heading>Cartoon Animal</Heading>
          <div className="py-5">
            {movie.length > 0 && (
              <div>
                <div>
