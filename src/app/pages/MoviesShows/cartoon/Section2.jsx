...
import { cartoon3, cartoon4 } from "../../../../redux/dataFetch";
...
function Section2() {
  ...
  // import data for storing in cartoon3 redux store
  ...
  useEffect(() => {
    if (movie.length === 0) {
      ...
      dispatch(cartoon3(movie));
    }
  }, [movie]);


  // import data for storing in cartoon4 redux store
  ...
  useEffect(() => {
    if (movie.length === 0) {
      ...
      dispatch(cartoon4(movie2));
    }
  }, [movie2]);

  // get all movies from redux store
  const page1Data = useSelector((state) => state.cartoon3);
  const page2Data = useSelector((state) => state.cartoon4);
