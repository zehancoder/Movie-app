...
import { cartoon5, cartoon6 } from "../../../../redux/dataFetch";
...
function Section4() {
  ...
  const trandingPage1 = useSelector((state) => state.cartoon1);
    ...
    <>
      <div>
        ...
        <div className="flex items-center ">
          {carouselMovies.map(
            ({ poster_path, original_title, id, release_date }, i) => (
              <div
                  ...
                  <SingleMovieCarou
                    ...
                    leftText={
                      <div className="text-[#999999] pt-1.5 w-full flex items-center  justify-between ">
                        <p className="text-[12px] md:text-[13px] bg-[#141414] px-2 py-1 rounded">
                          Relese at {release_date}
                        </p>
                      </div>
                    }
                  />
