...
import { cartoon1, page2, cartoon2 } from "../../../../redux/dataFetch";
...
function Cartoon() {
  ...
  useEffect(() => {
    if (movie.length === 0) {
      ...
      dispatch(cartoon2(movie2));
    }
  }, [movie]);

  // get all movies from redux store
  const page1Data = useSelector((state) => state.cartoon1);
  const page2Data = useSelector((state) => state.cartoon2);

  const page1Movie = page2Data[0];
  ...
  return (
    <div className="w-[100vw] bg-[#141414] font-manrope py-5 md:px-3 overflow-x-hidden relative lg:mt-8 md:mt-6 mt-4 xl:mt-10">
      <Container
        className={
        ...
        <div className="md:py-10 sm:py-8 py-6 lg:py-14  overflow-x-hidden ">
          ...
          <div className="w-full">
            <div className="flex md:flex-row flex-col items-center justify-between w-full ">
              <Heading className={""}>Animated Worlds Await</Heading>
