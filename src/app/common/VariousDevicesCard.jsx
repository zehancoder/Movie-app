...
function VariousDevicesCard({deviceImg, drescription, device}) {
  ...
  return (
    <div  className='md:px-4 px-2 shadowDevices cursor-pointer lg:px-6 md:py-8 py-6 lg:py-12 customGradientColor lg:max-w-[440px] md:max-w-[340px] w-full m-2 xl:max-w-[470px] border border-[#1F1F1F] rounded-lg hover:scale-105 transition duration-200 ' >
        <div>
